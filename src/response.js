export default {
	...
	searchInformation: {
		...
		totalResults: '292000000',
		formattedTotalResults: '292,000,000'
	},
	items: [
		{
				...
				metatags: [
					{
						...
						author: 'CNBC',
						'og:title': 'TSLA:422.64 0.70 (0.17%) - Stock Price, Quote and News - CNBC',
		...
		},
		{
			...
			snippet:
				'Sign up to listen to Tesla, Inc. Q3 2020 Financial Results. 10/21/20202:30 PM \nPDT. First Name. Last Name. Email Address. Company Name. Tesla © 2020 ...',
			htmlSnippet:
				'Sign up to listen to \u003cb\u003eTesla\u003c/b\u003e, Inc. Q3 2020 Financial Results. 10/21/20202:30 PM \u003cbr\u003e\nPDT. First Name. Last Name. Email Address. Company Name. \u003cb\u003eTesla\u003c/b\u003e © 2020&nbsp;...',
				...
				metatags: [
					{
						...
						'apple-mobile-web-app-capable': 'yes',
						'twitter:description':
							'Join us on Wednesday, October 21 for Q3 2020 Financial Results with Q&A.'
					}
				],
				cse_image: [
					{
				...
				metatags: [
					{
						...
						viewport:
							'width=device-width, initial-scale=1.0, minimum-scale=1.0, maximum-scale=2.0, shrink-to-fit=no',
						'user.exp': 'default',
						'twitter:description':
							'View the latest Tesla Inc. (TSLA) stock price, news, historical charts, analyst ratings and financial information from WSJ.',
